...
def winner(flag, num1, num2):
    ...
    if flag == 1:
        print('Победитель', num1)
    else:
        print('Победитель', num2)


# game_conditions()

# number1 = input("Введите имя 1го игрока: ")
# number2 = input("Введите имя 2го игрока: ")

# num1, num2 = choice_first(number1, number2)
